var submitButton=document.getElementById("submit_form"),form=document.getElementById("email_form");form.addEventListener("submit",function(e){setTimeout(function(){submitButton.innerHTML="Sending...",submitButton.disabled=!0},1)});var scroll,h=document.documentElement,b=document.body,st="scrollTop",sh="scrollHeight",progress=document.querySelector("#progress"),scrollpos=window.scrollY,header=document.getElementById("header");document.addEventListener("scroll",function(){scroll=(h[st]||b[st])/((h[sh]||b[sh])-h.clientHeight)*100,progress.style.setProperty("--scroll",scroll+"%"),(scrollpos=window.scrollY)>100?(header.classList.remove("hidden"),header.classList.remove("fadeOutUp"),header.classList.add("slideInDown")):(header.classList.remove("slideInDown"),header.classList.add("fadeOutUp"),header.classList.add("hidden"))});
